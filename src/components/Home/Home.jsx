...
import videoFile1 from '../../assets/Home-images/videoplayback.webm';
...
const Home = () => {
  ...
  return (
    <>
      <div className={`home_div1 ${theme === 'dark' ? 'dark':''}`}>
        <div className="Home1">
      ...
      <div className='home-div4'>
        ...
        <div className='home-div4-content'>
          ...
          <p className={`${theme==='dark'?'dark':''}`}>At WonderBooks, we're dedicated to discovering talented children's authors who can inspire young minds.
           Our platform bridges the gap between imaginative stories and global entertainment industries.</p>
        </div>
      </div>
      <div className='home-div2'>
        ...
        <div className='video-container'>
           <button className='video-btn left' onClick={handlePrevVideo}>&#10094;</button>
           <video src={videos[currentVideoIndex]} height={'100%'} width={'100%'} loop autoPlay muted playsInline/>
           <button className='video-btn right' onClick={handleNextVideo}>&#10095;</button>
        </div>
      </div>
