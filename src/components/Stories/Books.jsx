  ...
  const handleFormSubmit = async (e) => {
    try {
      if (editMode) {
        ...
        await editStories(updatedStory, editStoryId);
  ...
  return (
    <>
      <div className="book-container">
        <h1 className='book-h1'>Children's Popular (Age 3-8)</h1>
      ...
      <div className="book-container">
        <h1 className='book-h1'>Children's Classics (Age 8-15)</h1>
        <div className='story-explore-content'>
      ...
      <div className="book-container">
        <h1 className='book-h1'>Popular Hits (Age Above 15)</h1>
        <div className='story-explore-content'>
        ...
        <button className='add-story-btn' onClick={() => setShowModal(true)}>Add Story</button>
      {showModal && (
        <div className='modal'>
          <div className='modal-content'>
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <button type='submit'>{editMode ? "Update Story" : "Add Story"}</button>
              <button type='submit' style={{margin:'1% 5%'}} onClick={() => setShowModal(false)}>Close</button>
            </form>
          </div>
        </div>
      )}
