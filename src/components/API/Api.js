...
export const postUserData = async(userData) => {
    try {
        return await axios.post(`${API_URL}/post`, userData);
    } catch (error) {
...
export const updateUserData = async (userId, userData) => {
    try {
        return await axios.put(`${API_URL}/edit/${userId}`, userData);
    } catch (error) {
...
export const getUserCart = async (userId) => {
    try {
        ...
        console.log("Error fetching user cart:", error.response ? error.response.data : error.message);
    }
}
